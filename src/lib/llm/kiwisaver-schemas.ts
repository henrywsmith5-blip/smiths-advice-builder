...
const KiwisaverClientSchema = z.object({
  ...
  employmentStatus: z.string().nullable().default(null),
  ...
  pir: z.string().nullable().default(null),
  goal: z.string().nullable().default(null),
  timeframe: z.string().nullable().default(null),
  firstHomeIntention: z.boolean().nullable().default(null),
  firstHomeTimeframe: z.string().nullable().default(null),
  riskProfileOutcome: z.string().nullable().default(null),
  riskTolerance: z.string().nullable().default(null),
  riskCapacity: z.string().nullable().default(null),
  esgPreference: z.string().nullable().default(null),
  otherAssetsDebts: z.string().nullable().default(null),
  emergencyFund: z.string().nullable().default(null),
  recommendedContribRate: z.string().nullable().default(null),
...
const NarrativeInputsSchema = z.object({
  ...
  riskProfileNarrativeHtml: z.string().nullable().default(null),
  strategyNarrativeHtml: z.string().nullable().default(null),
});
...
export const KiwisaverFactPackSchema = z.object({
  ...
  clients: z.array(KiwisaverClientSchema).min(1).default([{
    ...
    goal: null,
    timeframe: null,
    firstHomeIntention: null,
    firstHomeTimeframe: null,
    riskProfileOutcome: null,
    riskTolerance: null,
    riskCapacity: null,
    esgPreference: null,
    otherAssetsDebts: null,
    emergencyFund: null,
    recommendedContribRate: null,
